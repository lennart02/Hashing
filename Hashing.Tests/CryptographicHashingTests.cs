...
[TestClass]
public class CryptographicHashingTests
{
  [TestMethod]
  public void TestMd5Hash()
  {
    ...
    // Act
    string actualHash = CryptographicHashFunctions.GetMd5Hash(input);
  ...
  public void TestSha1Hash()
  {
    ...
    // Act
    string actualHash = CryptographicHashFunctions.GetSha1Hash(input);
  ...
  public void TestSha256Hash()
  {
    ...
    // Act
    string actualHash = CryptographicHashFunctions.GetSha256Hash(input);
  ...
  public void TestSha512Hash()
  {
    ...
    // Act
    string actualHash = CryptographicHashFunctions.GetSha512Hash(input);
